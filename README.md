...
Repo inspired by [Papers we Love](https://github.com/papers-we-love/papers-we-love) ⭐ 109,031 | 🐛 3 | 🌐 Shell | 📅 2026-08-24
...
[`hack-different/apple-knowledge/_data`](https://github.com/hack-different/apple-knowledge/tree/main/_data) ⭐ 1,379 | 🐛 3 | 🌐 Ruby | 📅 2026-08-16
...
* [Unicorn Engine](https://github.com/unicorn-engine/unicorn) ⭐ 9,270 | 🐛 216 | 🌐 C | 📅 2026-07-30
* [Capstone Engine](https://github.com/aquynh/capstone) ⭐ 8,975 | 🐛 365 | 🌐 C | 📅 2026-08-24
* [`blacktop/ipsw`](https://github.com/blacktop/ipsw) ⭐ 3,669 | 🐛 7 | 🌐 Go | 📅 2026-08-26
...
* [ktool](https://github.com/cxnder/ktool) ⭐ 523 | 🐛 16 | 🌐 Python | 📅 2026-03-07 - FOSS Python Mach-O Tool
...
* [IDA Disassembler by Hex-Rays](https://hex-rays.com/ida-pro/)
  * [`onethawt/idaplugins-list`](https://github.com/onethawt/idaplugins-list) ⭐ 3,832 | 🐛 8 | 📅 2024-05-31
  ...
  * [`cellebrite-srl/FunctionInliner`](https://github.com/cellebrite-srl/FunctionInliner) ⭐ 228 | 🐛 0 | 🌐 C | 📅 2024-12-31
...
* [Ghidra Disassembler](https://ghidra-sre.org)
  * [`AllsafeCyberSecurity/awesome-ghidra`](https://github.com/AllsafeCyberSecurity/awesome-ghidra) ⭐ 1,427 | 🐛 3 | 📅 2026-06-18
...
* [OWASP: iOS Tampering and Reverse Engineering](https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06c-Reverse-Engineering-and-Tampering.md) ⭐ 13,139 | 🐛 234 | 🌐 Python | 📅 2026-08-14
...
* APFS - Apple Filesystem
  * [`sgan81/apfs-fuse`](https://github.com/sgan81/apfs-fuse) ⭐ 2,137 | 🐛 125 | 🌐 C++ | 📅 2024-08-13
  * [`libyal/libfsapfs`](https://github.com/libyal/libfsapfs) ⭐ 420 | 🐛 8 | 🌐 C | 📅 2026-08-04
...
* AirPlay2
  * [`mikebrady/shareport-sync`](https://github.com/mikebrady/shairport-sync) ⭐ 8,827 | 🐛 20 | 🌐 C | 📅 2026-08-26
...
* [Mach-O File Types](docs/MachO.md) - Mach-O / Signing / Entitlements
  * [`ProcursusTeam/ldid`](https://github.com/ProcursusTeam/ldid) ⭐ 274 | 🐛 2 | 🌐 C++ | 📅 2026-07-24 - Alternative to sbingner/ldid with
...
* img4 - Apple signed images, version 4
  ...
  * [`m1stadev/PyIMG4`](https://github.com/m1stadev/PyIMG4) ⭐ 67 | 🐛 16 | 🌐 Python | 📅 2026-08-24 - A Python library/CLI tool for parsing IMG4
...
* Swift
  * [Swift Mangling](https://github.com/apple/swift/blob/main/docs/ABI/Mangling.rst) ⭐ 70,302 | 🐛 9,251 | 🌐 Swift | 📅 2026-08-27
...
* ARM General
  * [Siguza's ARM Bootcamp](https://github.com/Siguza/ios-resources/blob/master/bits/arm64.md) ⭐ 1,966 | 🐛 4 | 📅 2025-05-24
...
* Apple CPUs
  * [Asahi: Introduction to Apple Silicon](https://github.com/AsahiLinux/docs/wiki/Introduction-to-Apple-Silicon) ⭐ 2,263 | 🐛 20 | 🌐 HTML | 📅 2026-08-02
  * [dougallj's applecpu](https://dougallj.github.io/applecpu/firestorm.html)
* Compilers
  * [ARM Clang PAC ABI](https://github.com/apple/llvm-project/blob/apple/main/clang/docs/PointerAuthentication.rst) ⭐ 1,240 | 🐛 623 | 🌐 LLVM | 📅 2026-08-27
* ARM Mitigations
...
* [hollance/neural-engine](https://github.com/hollance/neural-engine) ⭐ 2,522 | 🐛 10 | 📅 2026-03-12
* RTKit - "Realtime" Kit
...
* Basically all iDevice / iTunes
  * [`libimobiledevice/libimobiledevice`](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,135 | 🐛 848 | 🌐 C | 📅 2026-06-10
  * [`doronz88/pymobiledevice3`](https://github.com/doronz88/pymobiledevice3) ⭐ 2,668 | 🐛 39 | 🌐 Python | 📅 2026-08-26
...
* usbmuxd - USB transport for iDevices
  * [`libimobiledevice/usbmuxd`](https://github.com/libimobiledevice/usbmuxd) ⭐ 1,753 | 🐛 117 | 🌐 C | 📅 2025-12-06
...
* Apple Wi-Fi Password Sharing
  * [`seemoo-lab/openwifipass`](https://github.com/seemoo-lab/openwifipass) ⭐ 836 | 🐛 3 | 🌐 Python | 📅 2026-08-17
...
* Apple `tracev3` Unified Logging
  * [dtformats](https://github.com/libyal/dtformats/blob/main/documentation/Apple%20Unified%20Logging%20and%20Activity%20Tracing%20formats.asciidoc) ⭐ 199 | 🐛 10 | 🌐 Python | 📅 2026-07-04
...
* [`axi0mX/ipwndfu`](https://github.com/axi0mX/ipwndfu) ⭐ 7,397 | 🐛 168 | 🌐 Python | 📅 2024-02-21
...
* [`ProcursusTeam/Procursus`](https://github.com/ProcursusTeam/Procursus) ⭐ 1,002 | 🐛 150 | 🌐 Makefile | 📅 2026-08-01
* [ElleKit](https://github.com/evelyneee/ellekit) ⭐ 698 | 🐛 11 | 🌐 Swift | 📅 2026-07-31
...
* [pongoOS](https://github.com/checkra1n/pongoOS) ⭐ 2,746 | 🐛 48 | 🌐 C | 📅 2025-07-03
* [Android on pongoOS](https://github.com/corellium/projectsandcastle) ⭐ 2,101 | 🐛 10 | 🌐 C | 📅 2023-03-25
  * [iphonelinux](https://github.com/planetbeing/iphonelinux) ⭐ 618 | 🐛 14 | 🌐 C | 📅 2023-07-09
* [Corellium's M1 Branch](https://github.com/corellium/linux-m1) ⭐ 871 | 🐛 0 | 🌐 C | 📅 2021-02-24
* [Asahi Linux for M1](https://asahilinux.org)

## Safety / Protection

* [`mvt-project/mvt`](https://github.com/mvt-project/mvt) ⭐ 12,969 | 🐛 44 | 🌐 Python | 📅 2026-08-26
...
[Hack Different](https://github.com/hack-different/apple-knowledge) ⭐ 1,379 | 🐛 3 | 🌐 Ruby | 📅 2026-08-16{:xmlns:cc="<http://creativecommons.org/ns#>",
